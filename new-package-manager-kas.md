...
Yes, kas files can include other kas files using the includes keyword. These can be local file paths or paths to other repos.
...
kas files define repos and their versions. These can be specified as:
...
git commits, tags and branches will be supported.
